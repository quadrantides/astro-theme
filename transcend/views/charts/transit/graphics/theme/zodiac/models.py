...
#             textinfo = 'label'
#
#         rmax, rmin, domain = self.get_zodiac(WHEEL)
#
#         images_radius_in_xy_coords = self.get_zodiac_annotation_radius(WHEEL)
#
#         graduations = self.get_graduations(WHEEL)
#
#         dtick = self.get_polar_angularaxis_dticks(WHEEL)
#
#         structure = dict(
#             opacity=1.0,
#             # opacity=0.5,
